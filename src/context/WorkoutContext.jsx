...
const DEFAULT_EXERCISES = [
    ...
    { "id": "wt_deadlift", "name": "Deadlift", "category": "Weights", "primary_muscle": "Back", "equipment": "Barbell", "instructions": "Keep back flat and bar close to shins; drive through the heels to stand upright.", "illustration": "/illustrations/wt_deadlift.png" },
    ...
    { "id": "cal_decline_pushup", "name": "Decline Push-up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Chest", "equipment": "Bench/Elevated Surface", "instructions": "Place feet on an elevated surface; this increases the weight on the upper chest and shoulders." },
    { "id": "cal_wide_pushup", "name": "Wide Grip Push-up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Chest", "equipment": "None", "instructions": "Set hands wider than shoulder-width to increase the focus on the outer pectoral muscles." },
    { "id": "cal_diamond_pushup", "name": "Diamond Push-up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Arms", "equipment": "None", "instructions": "Place hands together so index fingers and thumbs form a diamond; focuses heavily on the triceps." },
    { "id": "cal_dip", "name": "Tricep Dip", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Arms", "equipment": "Parallel Bars/Bench", "instructions": "Lower your body by bending elbows to 90 degrees, then push back up using your triceps." },
    { "id": "cal_pullup", "name": "Pull-up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Back", "equipment": "Pull-up Bar", "instructions": "With palms facing away, pull your chin over the bar using your back and arm strength." },
    { "id": "cal_chinup", "name": "Chin-up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Back", "equipment": "Pull-up Bar", "instructions": "With palms facing you, pull your chin over the bar; this targets the biceps more than a pullup." },
    { "id": "cal_inverted_row", "name": "Inverted Row", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Back", "equipment": "Low Bar", "instructions": "Hang under a bar and pull your chest toward it, keeping your body in a straight line." },
    { "id": "cal_squat", "name": "Bodyweight Squat", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Legs", "equipment": "None", "instructions": "Lower your hips as if sitting in a chair, keeping your chest up and weight on your heels." },
    { "id": "cal_lunge", "name": "Bodyweight Lunge", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Legs", "equipment": "None", "instructions": "Step forward and lower your hips until both knees are bent at a 90-degree angle." },
    { "id": "cal_glute_bridge", "name": "Glute Bridge", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Legs", "equipment": "None", "instructions": "Lying on your back, lift your hips toward the ceiling by squeezing your glutes." },
    { "id": "cal_calf_raise", "name": "Bodyweight Calf Raise", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Legs", "equipment": "None", "instructions": "Stand on the balls of your feet and lift your heels as high as possible." },
    { "id": "cal_leg_raise", "name": "Leg Raises", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "Lying on your back, lift straight legs toward the ceiling and lower them slowly without touching the floor." },
    { "id": "cal_plank", "name": "Plank", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "isDurationBased": true, "instructions": "Hold a straight line from head to heels on your elbows, engaging your core and glutes." },
    { "id": "cal_side_plank", "name": "Side Plank", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "isDurationBased": true, "instructions": "Balance on one forearm and the side of your foot, keeping your hips lifted and body straight." },
    { "id": "cal_crunch", "name": "Abdominal Crunch", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "Curl your shoulders toward your knees by contracting your abs; avoid pulling on your neck." },
    { "id": "cal_mtn_climber", "name": "Mountain Climbers", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "In a plank position, drive your knees toward your chest in an alternating, running motion." },
    { "id": "cal_burpee", "name": "Burpees", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Full Body", "equipment": "None", "instructions": "Drop into a pushup, jump your feet forward, and explosively jump into the air." },
    { "id": "cal_jumping_jack", "name": "Jumping Jacks", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Full Body", "equipment": "None", "instructions": "Jump while spreading legs and touching hands overhead, then return to a standing position." },
    { "id": "cal_superman", "name": "Superman", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Back", "equipment": "None", "instructions": "Lying face down, lift your arms and legs off the ground simultaneously to strengthen the lower back." },
    { "id": "cal_bear_crawl", "name": "Bear Crawl", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Full Body", "equipment": "None", "isDurationBased": true, "instructions": "Crawl forward on hands and toes, keeping your hips low and back flat." },
    { "id": "cal_hollow_hold", "name": "Hollow Body Hold", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "isDurationBased": true, "instructions": "Press your lower back into the floor and lift your arms and legs slightly, holding a 'banana' shape." },
    { "id": "cal_wall_sit", "name": "Wall Sit", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Legs", "equipment": "Wall", "isDurationBased": true, "instructions": "Leaning against a wall, lower your hips until your thighs are parallel to the floor and hold." },
    { "id": "cal_russian_twist", "name": "Russian Twist", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "Sit with knees bent and feet elevated; rotate your torso to touch the floor on each side." },
    { "id": "cal_bicycle_crunch", "name": "Bicycle Crunch", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "Bring opposite elbow toward opposite knee in a pedaling motion, engaging the obliques." },
    { "id": "cal_v_up", "name": "V-Up", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "instructions": "Simultaneously lift your torso and legs to meet in a 'V' shape at the top." },
    { "id": "cal_flutter_kick", "name": "Flutter Kicks", "category": "Calisthenics", "isBodyweight": true, "primary_muscle": "Abs", "equipment": "None", "isDurationBased": true, "instructions": "Lying on your back, kick your legs up and down in small, rapid movements while keeping core tight." },
